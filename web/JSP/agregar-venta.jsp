<%-- 
    Document   : agregar-venta
    Created on : Oct 25, 2024, 7:29:05 PM
    Author     : leopa
--%>
...
<html>
    ...
    <body>
        ...
        <jsp:include page="header.jsp">
            <jsp:param name="page" value="agregar-venta.jsp" />
        </jsp:include>
